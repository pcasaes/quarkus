...
performance improvements on certain platforms. To enable them you must include one or both of the following dependencies:
...
Netty will ignore these transports on unsupported platforms.
