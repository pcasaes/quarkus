    ...
    private static class WebDeploymentVerticle extends AbstractVerticle {
        ...
        public void start(Future<Void> startFuture) {
            ...
            if (httpOptions != null) {
                ...
                setupTcpHttpServer(httpServer, httpOptions, "http", startFuture, remainingCount);
            }
            ...
            if (httpsOptions != null) {
                ...
                setupTcpHttpServer(httpsServer, httpsOptions, "https", startFuture, remainingCount);
            }
        }
        ...
        private void setupTcpHttpServer(HttpServer httpServer, HttpServerOptions options, String schema,
